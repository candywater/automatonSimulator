var pda_delegate = (function() {
  ...
  var makeDialog = function() {
    ...
    //maxlength 1 -> 10
    $('<input />', {id:'pda_dialog_readCharTxt', type:'text', maxlength:10, style:'width:30px;text-align:center;', title:'Read from Input'}).val('A').appendTo(dialogDiv);
    $('<input />', {id:'pda_dialog_popCharTxt', type:'text', maxlength:10, style:'width:30px;text-align:center;', title:'Pop from Stack'}).val('').appendTo(dialogDiv);
    $('<input />', {id:'pda_dialog_pushCharTxt', type:'text', maxlength:10, style:'width:30px;text-align:center;', title:'Push to Stack'}).val('').appendTo(dialogDiv);
